    ...
    return (
        <div className='content-course'>
            ...
            <div className='qorgan'>
                <p> <strong>Qorgan Project</strong> - это проект, посвященный предотвращению сексуализированного насилия над детьми, их курс будет полезен родителям и взрослым. Обязательно посмотрите бесплатные уроки! Посмотреть полный курс можно по ссылке: <br /> <a href="https://www.youtube.com/watch?v=xF8GTviihQ4&list=PLdpm5MUquwobOPmz4AmPgl36nvQcby5he"><i style={{fontWeight: 400}}>Ссылка на курс</i></a></p>
